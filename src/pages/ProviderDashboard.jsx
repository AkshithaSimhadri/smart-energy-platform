...
import { 
  ...
  CreditCard, LogOut, CheckCircle, XCircle, Clock
} from 'lucide-react';
    ...
    <div className="w-64 bg-slate-900 border-r border-white/10 h-screen fixed left-0 top-0 p-4 flex flex-col">
      ...
      <div className="border-t border-white/10 pt-4 mt-auto space-y-2">
        <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-white/5 border border-white/5">
          ...
          <ThemeToggle id="provider-sidebar-theme-toggle" compact={true} />
        </div>
        <button className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-red-500/10 hover:text-red-400 transition-all w-full text-left">
